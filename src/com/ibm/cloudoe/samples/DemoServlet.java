...
public class DemoServlet extends HttpServlet {
	...
	private String username = "e5473097-5f76-4646-a841-37c7e2b6473a";
	private String password =  "tzDCZWz1tCiP";
	...
	private void processVCAPServices() {
		...
		for (Object key : sysEnv.keySet()) {
			...
			if (keyString.startsWith(serviceName)) {
				JSONArray services = (JSONArray) sysEnv.get((String) key);
	...
	private JSONObject getVCAPServices() {
		...
		JSONObject sysEnv = null;
                sysEnv = JSONObject.parse(envServices); // Do nothing, fall through to defaults
		return sysEnv;
	}
